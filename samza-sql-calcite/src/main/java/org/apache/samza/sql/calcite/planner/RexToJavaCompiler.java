...
public class RexToJavaCompiler {
  ...
  /**
   * Compiles a row expression to a instance of {@link org.apache.samza.sql.api.expressions.Expression}
   * @param inputs Input relations/time-varying relations for this row expression
   * @param nodes row expression
   * @return compiled expression of type {@link org.apache.samza.sql.api.expressions.Expression}
   */
  public org.apache.samza.sql.api.expressions.Expression compile(List<RelNode> inputs, List<RexNode> nodes) {
    /*
  ...
  /**
   * Given a method that implements {@link org.apache.samza.sql.api.expressions.Expression#execute(Object[], Object[])},
   * adds a bridge method that implements {@link org.apache.samza.sql.api.expressions.Expression#execute(Object[])}, and
   * compiles.
   */
  static org.apache.samza.sql.api.expressions.Expression baz(ParameterExpression inputValues,
    ...
    final ClassDeclaration classDeclaration =
        Expressions.classDecl(Modifier.PUBLIC, "SqlExpression", null,
            ImmutableList.<Type>of(org.apache.samza.sql.api.expressions.Expression.class), declarations);
  ...
  static org.apache.samza.sql.api.expressions.Expression getExpression(ClassDeclaration expr, String s)
    ...
    return (org.apache.samza.sql.api.expressions.Expression) cbe.createInstance(new StringReader(s));
  }

  public enum SamzaBuiltInMethod {
    EXPR_EXECUTE1(org.apache.samza.sql.api.expressions.Expression.class, "execute", Object[].class),
    EXPR_EXECUTE2(org.apache.samza.sql.api.expressions.Expression.class, "execute", Object[].class, Object[].class);
