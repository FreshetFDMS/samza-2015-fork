...
public class ProjectSpec extends TypeAwareOperatorSpec implements OperatorSpec {

  public static final String OP_TYPE = "Project";

  private Expression projectExpression;

  public ProjectSpec(EntityName input, EntityName output, Expression projectExpression, Schema inputType, Schema outputType) {
