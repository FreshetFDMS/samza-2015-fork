...
FILTER_OUTPUT_TOPIC = 'filteredorders'
...
def validate_sql_filter_query():
    ...
    kafka.ensure_topic_exists(FILTER_OUTPUT_TOPIC)
    consumer = SimpleConsumer(kafka, 'sql-filter-query-group', FILTER_OUTPUT_TOPIC)
