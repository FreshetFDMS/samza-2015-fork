...
JOB_ID = 'sql_filter_test'
PACKAGE_ID = 'tests'
CONFIG_FILE = 'config/sql-filter.properties'
TEST_INPUT_TOPIC = 'orders'
TEST_OUTPUT_TOPIC = 'filteredorders'
NUM_MESSAGES = 5
...
def validate_sql_filter_query():
    ...
    consumer = SimpleConsumer(kafka, 'sql-filter-query-group', TEST_OUTPUT_TOPIC)
